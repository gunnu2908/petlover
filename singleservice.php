...
<div class="container py-5">
    <div class="row pt-5">
        ...
        // Fetch the latest service code from sertemp
        $data = "SELECT * FROM sertemp";
        $result = mysqli_query($con, $data);
        while ($row = $result->fetch_assoc()) {
            $a = $row['scode'];
        }

        // Fetch service details using the retrieved service code
        $data = "SELECT * FROM adminservice WHERE ServiceCode='$a'";
        $result = mysqli_query($con, $data);
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-white mb-2" href="home.php"><i class="fa fa-angle-right mr-2"></i>About Us</a>
                            <a class="text-white mb-2" href="home.php"><i class="fa fa-angle-right mr-2"></i>Our Services</a>
                            <a class="text-white mb-2" href="home.php"><i class="fa fa-angle-right mr-2"></i>Our Team</a>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    ...
                    <a class="text-white font-weight-bold" href="https://INDEX.PHP">GUNNPREER KAUR</a>
                </p>
            </div>
