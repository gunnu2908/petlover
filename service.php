...
<head>
    <meta charset="utf-8">
    <title>PetCarehub- Pet Care Website</title>
            ...
            <?php
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p><?php echo $g; ?></p>
                        <form method="POST">
                            <input type="hidden"name="scode" value="<?php echo $b; ?>">
                        <button type="submit" name="btn1" class="btn btn-lg btn-primary px-3 d-none d-lg-block">Read More</button>
</form>
                    </div>
                </div>
                <?php } ?>
...
<?php
 ...
 {
 $a=$_POST['scode'];
 $data="delete from sertemp";
mysqli_query($con,$data);
 $data="insert into sertemp values('$a')";
 mysqli_query($con,$data);
 echo "<script>location.href='singleservice.php';</script>";
 }
?>
