...
<a href="cartview.php" class="nav-link text-white position-relative">
    ...
    <div class="container-fluid pt-5">
        <div class="d-flex flex-column text-center mb-5 pt-5">
            <h4 class="text-secondary mb-3">Pet Sale</h4>
            <h1 class="display-4 m-0">FIND YOUR <span class="text-primary">Location Where Sale Pet</span></h1>
        </div>
                ...
                <div class="contact-form">
                    ...
                    <form  method="POST">
                        <div class="control-group">
                            <input type="text" class="form-control" id="t1" name="t1" value="<?php echo $a; ?>" />
                        </div><br/>
                        <div class="control-group">
                        
                                   
                                    <select name="t2" class="form-control">
                                    <option value="select any 1 option">Pet type</option>
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="t3" name="t3"placeholder="Breed" required="required" />  
                        </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t4" name="t4"placeholder="Age" required="required" />
                        ...
                        <div class="control-group">
                                ...
                                <select name="t5" class="form-control" >
                                    <option value="select Any One">Gender</option>
                                    <option value="Male">Male</option>
                                    <option value="FeMale">Female</option>
                                    </select>
                                    </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t6" name="t6"placeholder="Color" required="required" />
                            
                        </div><br/>
                        <div class="control-group">
                       
                        <div class="control-group">
                        <input type="text" class="form-control" id="t7" name="t7"placeholder="Weight" required="required" />
                        ...
                        <select name="t8" class="form-control">
                                    <option value="select Any One">Health Status</option>
                        ...
                        <select name="t9" class="form-control">
                                    <option value="select any One">Choose Special Needs</option>
                                    <option value="yes">yes</option>
                                    <option value="no">no</option>
                                    </select>
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t10" name="t10"placeholder="Description" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="file" class="form-control" id="t11" name="t11" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t12" name="t12"placeholder="Customer email" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t13" name="t13"placeholder="Contact no" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t14" name="t14"placeholder="Name" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t15" name="t15"placeholder="Address" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t16" name="t16"placeholder="State" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t17" name="t17"placeholder="City" required="required" />
                            </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control" id="t18" name="t18"placeholder="Zipcode" required="required" />
                            </div><br/>
                            <div class="control-group">
                            <input type="text" class="form-control" id="t19" name="t19"placeholder="Pet rate" required="required" />
                            </div><br/>
                            <button class="btn btn-primary" type="submit" id="b1" name="b1">Register</button>
                            <button class="btn btn-primary" type="submit" id="b2" name="b2">Reset</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <form action="" method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control border-0" placeholder="Your Name" required="required" name="tt1"/>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control border-0" placeholder="Your Email" required="required" name="tt2" />
                            </div>
                            <div>
