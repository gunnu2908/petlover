            ...
            <div class="col-12 col-sm-8 mb-5">
                <div class="contact-form">
                    ...
                    <form novalidate="novalidate" method="POST">
                        ...
                        <div class="control-group">
                            <input type="email" class="form-control p-4" id="t1" name="t1"placeholder="Email" required="required"  />
                        </div><br/>
                        <div class="control-group">
                            <input type="password" class="form-control p-4" id="t2" name="t2"placeholder="Password" required="required" />  
                        </div><br/>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-envelope mr-2"></i>petlover6@gmail.com</p>
