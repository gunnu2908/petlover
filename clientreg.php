...
if($c==$d)
{
$data="Insert into clientreg values('$a','$b','$c','$e','$f','$g','$h')";
...
echo'<script type="text/javascript">';
echo'alert("Password & Confirm Password Not Match")';
echo'</script>';
$c="";
$d="";
}
                ...
                <div class="contact-form">
                    ...
                    <form novalidate="novalidate" method="POST">
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="t1" name="t1"placeholder="Full Name" required="required" />
                        </div><br/>
                        <div class="control-group">
                            <input type="email" class="form-control p-4" id="t2" name="t2"placeholder="Your Email" required="required"  />
                        </div><br/>
                        <div class="control-group">
                            <input type="password" class="form-control p-4" id="t3" name="t3"placeholder="Password" required="required" />  
                        </div><br/>
                        <div class="control-group">
                            <input type="password" class="form-control p-4" id="t4" name="t4"placeholder="Confirm Password" required="required" />
                          
                        </div><br/>
                      
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="t5" name="t5" placeholder="Address" required="required" />
                            
                        </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="t6" name="t6"placeholder="City" required="required" />
                            
                        </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="t7" name="t7"placeholder="State" required="required"  />
                            
                        </div><br/>
                        <div class="control-group">
                            <input type="text" class="form-control p-4" id="t8" name="t8"placeholder="Mobile no" required="required" />
